...
<body class="theme-blue">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('dashboard'); ?>"><?php echo $_app_name . ' <small> - Fakultas Ilmu Komputer Universitas Muslim Indonesia</small>'; ?></a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright &copy; <?php echo date('Y'); ?>. <a href="mailto:kelompok1@email.com?subject=Tanya aplikasi Tracer Study">Kelompok 1</a>.
                </div>
                <div class="version">
