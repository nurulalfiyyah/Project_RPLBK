...
<body class="event-lp">
  ...
  <header>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-flex-icons">
            <li class="nav-item">
              <?php echo (!empty($kontak['facebook_url']) ? anchor($kontak['facebook_url'], '<i class="fab fa-facebook-f"></i>', 'class="nav-link"') : '<a href="https://www.facebook.com/Fak.Ilmu.Komputer.Umi/" target="_blank" class="nav-link"><i class="fab fa-facebook-f"></i></a>'); ?>
            </li>
            <li class="nav-item">
              <?php echo (!empty($kontak['chrome_url']) ? anchor($kontak['chrome_url'], '<i class="fab fab fa-chrome"></i>', 'class="nav-link"') : '<a href="https://fikom.umi.ac.id/" target="_blank" class="nav-link"><i class="fab fab fa-chrome"></i></a>'); ?>
            </li>
            <li class="nav-item">
              <?php echo (!empty($kontak['instagram_url']) ? anchor($kontak['instagram_url'], '<i class="fab fa-instagram"></i>', 'class="nav-link"') : '<a href="https://www.instagram.com/fikom.umi/" target="_blank" class="nav-link"><i class="fab fa-instagram"></i></a>'); ?>
            </li>
            <li class="nav-item">
              <?php echo (!empty($kontak['youtube_url']) ? anchor($kontak['youtube_url'], '<i class="fab fa-youtube"></i>', 'class="nav-link"') : '<a href="https://www.youtube.com/c/FIKOMUMI" target="_blank" class="nav-link"><i class="fab fa-youtube"></i></a>'); ?>
            </li>
    ...
    <!--Navbar-->
    <!-- Intro Section -->
    <div id="home" class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('<?php echo base_url('assets/landing-page/images/bg_fiko.png'); ?>'); background-repeat: no-repeat; background-size: cover; background-position: center;">
          ...
          <div class="row smooth-scroll">
            <div class="col-md-12 white-text text-center">
              <div class="wow fadeInDown" data-wow-delay="0.2s">
                ...
                <hr class="hr-light">
                <h3 class="subtext-header mt-4 mb-5">Fakultas Ilmu Komputer Universitas Muslim Indonesia</h3>
              </div>
  ...
  <footer class="page-footer indigo darken-3 text-center text-md-left pt-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 ml-lg-auto col-md-4 mt-1 mb-1 wow fadeIn" data-wow-delay="0.3s">
          ...
          <p>
            ...
            Gedung Fakultas Ilmu Komputer, Kampus II UMI, Jln. Urip Sumoharjo, KM. 5, Makassar, Sulawesi Selatan
          </p>
          <p>
    ...
    <div class="footer-copyright py-3 text-center">
      <div class="container-fluid">
        © 2022 Copyright: <a href="https://mdbootstrap.com/education/bootstrap/" target="_blank"> MDBootstrap.com </a>
      </div>
    </div>
    <!--/Copyright-->
